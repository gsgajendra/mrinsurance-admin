...
<head>
    <meta charset="UTF-8">
    <title>Vehicle List | Admin</title>
                        ...
                        <div class="portlet box primary">
                            <div class="portlet-title">
                                <div class="row Nopadding">
									...
									<div class="col-md-6">
										<a href="add-vehicle-master.php" class="btn btn-sm btn-success pull-right">Add New</a>
									</div>
								</div>
                            </div>
                                ...
                                <table class="table table-bordered table-striped table-condensed flip-content">
                                    <thead class="flip-content">
                                        <tr>
                                            ...
                                            <th class="numeric">Cylinders</th>
                                            <th class="numeric">Car Price</th>
                                            <th class="numeric">Rating Category</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>Toyota</td>
                                            <td class="numeric">Camry 1.6Lt</td>
											<td class="numeric">Saloon</td>
                                            <td class="numeric">4</td>
                                            <td class="numeric">58000</td>
                                            <td class="numeric">Category 1</td>
                                            <td class="numeric">Incomplete</td>
                                            <td class="numeric">
