                        ...
                        <div class="portlet box primary">
                            <div class="portlet-title">
                                <div class="row Nopadding">
									...
									<div class="col-md-6">
										<a href="add-user.php" class="btn btn-sm btn-success pull-right">Add New</a>
									</div>
								</div>
                            </div>
                                ...
                                <table class="table table-bordered table-striped table-condensed flip-content">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>10-Oct-20</td>
                                            <td class="numeric">Ikram007</td>
											<td class="numeric">mohammedikramulla@gmail.com</td>
                                            <td class="numeric">
												<img src="http://placehold.it/50X50" alt="Title Here"/>
											</td>
                                            <td class="numeric">Editor</td>
