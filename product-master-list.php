                        ...
                        <div class="portlet box primary">
                            <div class="portlet-title">
                                <div class="row Nopadding">
									...
									<div class="col-md-6">
										<a href="add-product-master.php" class="btn btn-sm btn-success pull-right">Add New</a>
									</div>
								</div>
                            </div>
                                ...
                                <table class="table table-bordered table-striped table-condensed flip-content">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="numeric">TPL</td>
											<td class="numeric">Standard</td>
                                            <td class="numeric">25/10/2020</td>
