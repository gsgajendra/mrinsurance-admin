...
<head>
    <meta charset="UTF-8">
    <title>Nationality List | Admin</title>
                                ...
                                <div class="row Nopadding">
									<div class="col-md-6">
										<h3 class="caption NoMar">
												<span>Nationality List</span>
										</h3>
									</div>
									<div class="col-md-6">
										<a href="add-nationality-master.php" class="btn btn-sm btn-success pull-right">Add New</a>
									</div>
								</div>
                            </div>
