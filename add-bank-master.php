                            ...
                            <div class="portlet-body flip-scroll">
								<div class="row">
									<div class="col-md-6 col-md-offset-3" style="display: block;">
										<div class="form-group ui-draggable-handle" style="position: static;"><label for="input-text-1">Bank Name</label>
											<input type="text" class="form-control" id="input-text-1" placeholder="Bank Name">
										</div>
										<hr/>
