...
<head>
    <meta charset="UTF-8">
    <title>Promo Code List | Admin</title>
                        ...
                        <div class="portlet box primary">
                            <div class="portlet-title">
                                <div class="row Nopadding">
									...
									<div class="col-md-6">
										<a href="add-promocode-master.php" class="btn btn-sm btn-success pull-right">Add New</a>
									</div>
								</div>
                            </div>
                                ...
                                <table class="table table-bordered table-striped table-condensed flip-content">
                                    <thead class="flip-content">
                                        <tr>
                                            <th>Sr. No.</th>
                                            <th>Promo  Name </th>
                                            <th class="numeric">Promo Code</th>
											<th class="numeric">Discount</th>
                                            <th class="numeric">Min Saving</th>
