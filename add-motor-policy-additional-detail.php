                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box primary">
                            ...
                            <div class="portlet-body flip-scroll">
                                <form action="add-motor-policy-uploadd-docs.php" method="post">
                                    <div class="row">
                                    ...
                                    <div class="col-md-6" style="display: block;">
										<div class="form-group ui-draggable-handle text-center" style="position: static;">
											<a href="add-motor-policy-additional-car-detail.php" class="btn btn-warning btn-lg"><i class="fa fa-arrow-left"></i> Back</a>
										</div>
									</div>
                                    <div class="col-md-6" style="display: block;">
                                        <div class="form-group ui-draggable-handle text-center" style="position: static;">
